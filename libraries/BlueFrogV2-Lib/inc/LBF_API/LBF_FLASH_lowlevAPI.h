...
#define FLASH_CMD_PAGESIZE1     0x3D       /* "Power of 2 Page Size" instruction, Byte1  */
...
/* Exported Macros    --------------------------------------------------------*/
#define FLASH_CS_LOW()          GPIO_LOW(FLASH_CS_PORT, FLASH_CS_PIN)
#define FLASH_CS_HIGH()         GPIO_HIGH(FLASH_CS_PORT, FLASH_CS_PIN)
