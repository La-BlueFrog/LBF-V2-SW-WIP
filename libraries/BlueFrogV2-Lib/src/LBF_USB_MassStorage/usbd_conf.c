/*
 * Adapted by La BlueFrog, 2015
 * from STM example provided as part of package STM32Cube_FW_L1_V1.0.0
*/
...
// UPDATE La BlueFrog 2015: if useless don't do it //
  /*
  ...
  */
  ...
  /* Enable SYSCFG Clock */
// UPDATE La BlueFrog 2015: already done in Inits elsewhere, so not needed here
/* 
  __SYSCFG_CLK_ENABLE();
*/

  /* Set USB Interrupt priority */
  // Original by ST:  HAL_NVIC_SetPriority(USB_LP_IRQn, 7, 0);
  // Update La BlueFrog 2015 (__USB_LP_IRQn_PRIO defined in LBF_Interrupts_Cfg.h)
  HAL_NVIC_SetPriority(USB_LP_IRQn, __USB_LP_IRQn_PRIO, 0);
